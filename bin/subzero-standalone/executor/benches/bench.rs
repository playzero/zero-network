...
const TRANSACTION_VERSION: u32 = subzero_standalone_runtime::VERSION.transaction_version;

const SPEC_VERSION: u32 = subzero_standalone_runtime::VERSION.spec_version;
