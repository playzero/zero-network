...
use subzero_standalone_runtime::{ExistentialDeposit, RuntimeApi};
...
impl SubstrateCli for Cli {
	...
	fn load_spec(&self, id: &str) -> std::result::Result<Box<dyn sc_service::ChainSpec>, String> {
		let spec = match id {
			...
			"" | "subzero" | "alphaville" => Box::new(chain_spec::subzero_standalone_config()?),
	...
	fn native_runtime_version(_: &Box<dyn ChainSpec>) -> &'static RuntimeVersion {
		&subzero_standalone_runtime::VERSION
	}
}
