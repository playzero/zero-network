...
pub fn compact_code_unwrap() -> &'static [u8] {
	alphaville_runtime::WASM_BINARY.expect(
...
pub const SPEC_VERSION: u32 = alphaville_runtime::VERSION.spec_version;

pub const TRANSACTION_VERSION: u32 = alphaville_runtime::VERSION.transaction_version;
